...
public class TsExecuter implements Serializable {
    ...
    public TsExecuter(String id, String update_by, Date update_time, String exec_name, String exec_addr, String exec_type, String exec_available, String exec_monopoly, Date exec_register, String exec_version) {
        this.id = id;
